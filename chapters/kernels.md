...
- **Optimal Transport for Structured Data with Application on Graphs (ICML 2019)**
  - Titouan Vayer, Nicolas Courty, Romain Tavenard, Laetitia Chapel, and Rémi Flamary
  - [[Paper]](http://proceedings.mlr.press/v97/titouan19a.html)
  - [[Python Reference]](https://github.com/PythonOT/POT)
...
- **Wasserstein Weisfeiler-Lehman Graph Kernels (NeurIPS 2019)**
  ...
  - [[Paper]](http://papers.neurips.cc/paper/8872-wasserstein-weisfeiler-lehman-graph-kernels)
...
- **On Valid Optimal Assignment Kernels and Applications to Graph Classification (NIPS 2016)**
  - Nils Kriege, Pierre-Louis Giscard, and Richard Wilson
...
- **A Graph Kernel Based on the Jensen-Shannon Representation Alignment (IJCAI 2015)**
  - Lu Bai, Zhihong Zhang, Chaoyan Wang, Xiao Bai, and Edwin R. Hancock
...
- **An Aligned Subtree Kernel for Weighted Graphs (ICML 2015)**
  - Lu Bai, Luca Rossi, Zhihong Zhang, and Edwin R. Hancock
  - [[Paper]](http://proceedings.mlr.press/v37/bai15.pdf)

- **Halting Random Walk Kernels (NIPS 2015)**
  - Mahito Sugiyama and Karsten M. Borgwardt
...
- **Fast Neighborhood Subgraph Pairwise Distance Kernel (ICML 2010)**
  ...
  - [[C++ Reference]](https://www.bioinf.uni-freiburg.de/~costa/EDeNcpp.tgz)
