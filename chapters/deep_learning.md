...
- **Graph Star Net for Generalized Multi-Task Learning (arXiv 2019)**
  - Haonan Lu, Seth H. Huang, Ye Tian, Xiuyan Guo
...
- **Hierarchical Graph Representation Learning with Differentiable Pooling (NeurIPS 2018)**
  ...
  - [[Paper]](https://papers.neurips.cc/paper/7729-hierarchical-graph-representation-learning-with-differentiable-pooling)
